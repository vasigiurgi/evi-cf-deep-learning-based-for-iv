...
#class DS2 computes the mass functions of singleton classes associated to each prototype using its corresponding actived distance
...
class DS2(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        beta=tf.add(beta,1e-10,name=None) # adding a small positive number, 1e-10
